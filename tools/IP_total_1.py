...
class AntColony:
    ...
    def run(self,timelimit = 100, num_mol_smallTree=25):
        ...
        # First constraint: each molecule uses at most one of its routes
        ...
        # Solve it
        solution = dict()
        solver = pulp.getSolver('PULP_CBC_CMD', timeLimit=timelimit)
...
if __name__ == '__main__':
    ...
    for component_id, component in enumerate(all_components):
        ...
        if run_ants:
            ...
            path = aco.run(num_mol_smallTree=num_mol_smallTree, timelimit=timelimit)
